...
namespace TheTennisProject
{
    ...
    public static class SqlTools
    {
        ...
        /// </summary>
        public static readonly string SQL_CONNECTION_STRING = string.Format(Settings.Default.ConnectionStringPattern,
            Settings.Default.SQL_server, Settings.Default.SQL_db, Settings.Default.SQL_uid, Settings.Default.SQL_pwd);
